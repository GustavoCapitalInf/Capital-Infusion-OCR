...
function InfoTooltip({ children }) {
  return (
    <div className="relative group flex items-center">
      ...
      <div className="absolute bottom-full right-0 mb-2 w-72 bg-[#0F172A] text-white text-xs rounded-xl px-4 py-3 shadow-lg border border-white/10 opacity-0 group-hover:opacity-100 pointer-events-none transition-opacity duration-150 z-50">
        {children}
      </div>
    </div>
  )
...
export default function Analysis() {
  ...
  const trendColor      = !fc ? 'text-text-muted' : fc.deltaPct > 1 ? 'text-green' : fc.deltaPct < -1 ? 'text-red' : 'text-text-muted'
  const confidenceColor = !fc ? '' : { High: 'text-green bg-green-light border-green-border', Medium: 'text-amber bg-amber-light border-amber-border', Low: 'text-text-muted bg-gray-100 border-border' }[fc.confidence]
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
            <div className="bg-white border border-border rounded-2xl p-6 shadow-xs">
              <div className="flex items-center justify-between mb-1">
                ...
                <span className="text-[10px] text-text-muted bg-amber-50 text-amber-600 border border-amber-200 px-2 py-1 rounded-full font-semibold">Risk</span>
              </div>
            ...
            <div className="bg-white border border-border rounded-2xl p-6 shadow-xs">
              <div className="flex items-center justify-between mb-1">
                ...
                <span className="text-[10px] text-text-muted bg-red-50 text-red-600 border border-red-200 px-2 py-1 rounded-full font-semibold">Risk</span>
              </div>
            ...
            <div className="bg-white border border-border rounded-2xl p-6 shadow-xs">
              <div className="flex items-center justify-between mb-1">
                ...
                <span className="text-[10px] text-text-muted bg-purple-50 text-purple-600 border border-purple-200 px-2 py-1 rounded-full font-semibold">Risk</span>
              </div>
